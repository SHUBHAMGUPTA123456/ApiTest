package com.example.apitest.Map;
...
public class MapActivity extends AppCompatActivity implements  OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        MarkerOptions markerOptions = new MarkerOptions().position(latLng).title(address).flat(true).icon(BitmapDescriptorFactory.fromBitmap(BitMapMarker));
        ...
        Log.d("kjdfgd", "onMapReady: "+lat+", "+lang);
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    setDataWithMarker(currentLocation.getLatitude(), currentLocation.getLongitude());
                }
            }
        });
    }
    ...
    private void setDataWithMarker(double lat, double lang) {
        Geocoder geocoder;
        ...
        try {
            ...
            Log.d("dfds", "setDataWithMarker: "+address);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
